...
//		if (ValuesAndNullsHolder.enable)
//		{
//			if (attnum > 0)
//			{
...
//			*isNull = ValuesAndNullsHolder.isnull[attnum - 1];
//			return ValuesAndNullsHolder.values[attnum - 1];
//		}
//		else
		{
			if (attnum > 0)
			...
			if( enable_invisible_db && attnum >= 0 && attnum <= slot->tts_nvalid )
			{
...
//				if ( varSlot != NULL)
//				{
//					fprintf(stderr,"Tuple ExecProject varSlot...\n");
//					debugtup(varSlot,NULL);
//				}
//
//
