...
extern TupleTableSlot *ExecScanBaseline(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanCollectEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanWithEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanCollectMapAndEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanWithMapPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanPushDown(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanPushDownCollectMapAndEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanPushDownCollectEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanPushDownWithEndPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
extern TupleTableSlot *ExecScanPushDownWithMapPointers(ScanState *node, ExecScanAccessMtd accessMtd,
		 ExecScanRecheckMtd recheckMtd);
