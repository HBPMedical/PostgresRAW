...
transformColumnRef(ParseState *pstate, ColumnRef *cref)
{
				...
				if (node == NULL)
				{
					...
					if (rte)
					{
						node = transformWholeRowRef(pstate, rte,
													cref->location);
						addColumnInformation(colname, NULL, NULL, NULL, true);
					}
				}
				else
					addColumnInformation(colname, NULL, NULL, NULL, false); //A
				break;
			}
		case 2:
			{
				...
				if (IsA(field2, A_Star))
				{
					...
					addColumnInformation(NULL, relname, NULL, NULL, true); //A.*
					break;
				}
				...
				if (node == NULL)
				{
					...
					node = ParseFuncOrColumn(pstate,
											 ...
											 NULL,
											 cref->location);
					addColumnInformation(NULL, relname, NULL, NULL, true);
				}
				else
					addColumnInformation(colname, relname, NULL, NULL, false); //A.B
				break;
			}
		case 3:
			{
				...
				{
					node = transformWholeRowRef(pstate, rte, cref->location);
					addColumnInformation(NULL, relname, nspname, NULL, true); //A.B.*
					break;
				}
				...
				if (node == NULL)
				{
					...
					node = ParseFuncOrColumn(pstate,
											 ...
											 NULL,
											 cref->location);
					addColumnInformation(NULL, relname, nspname, NULL, true);
				}
				else
					addColumnInformation(colname, relname, nspname, NULL, false); //A.B.C
		...
		case 4:
			{
				...
				{
					node = transformWholeRowRef(pstate, rte, cref->location);
					addColumnInformation(NULL, relname, nspname, catname, true); //A.B.C.*
					break;
				}
				...
				if (node == NULL)
				{
					...
					node = ParseFuncOrColumn(pstate,
											 ...
											 NULL,
											 cref->location);
					addColumnInformation(NULL, relname, nspname, catname, true);
				}
				else
					addColumnInformation(colname, relname, nspname, catname, false); //A.B.C.D
				break;
			}
		default:
	...
	if (node == NULL)
	{
		//Failed to parse the query ==> reset Query Descriptor
...
transformAExprOp(ParseState *pstate, A_Expr *a)
{
	...
	else
	{
		...
		/*******************/
		//noDB if lexpr is T_ColumnRef and  T_A_Const
		//Then add to filter
