				...
				if (IsA(llast(cref->fields), A_Star))
				{
					...
					p_target = list_concat(p_target,
										   ExpandColumnRefStar(pstate,
															   cref,
															   true));
					//In case of select * to include all the attributes in the list of interesting attributes
					addColumnInformation(NULL, NULL, NULL, NULL, true);
					 ...
					 Var *var, int levelsup)
{
	...
	switch (rte->rtekind)
	{
		case RTE_RELATION:
			...
			//In case of select * to include all the attributes in the list of interesting attributes
//			addColumnInformation(tle->resname, NULL, NULL, NULL, false);
			break;
		case RTE_SUBQUERY:
