...
agg_retrieve_direct(AggState *aggstate)
{
	...
	while (!aggstate->agg_done)
	{
		...
		if (aggstate->grp_firstTuple != NULL)
		{
			...
			//Added for noDB
			//The attributes are already available
//			if ( outerslot != NULL)
//			{
//				if ( outerslot->tts_nvalid > 0 )
//				{
//					tmpcontext->ecxt_outertuple->tts_nvalid = outerslot->tts_nvalid;
//					tmpcontext->ecxt_outertuple->tts_values = outerslot->tts_values;
//					tmpcontext->ecxt_outertuple->tts_isnull = outerslot->tts_isnull;
//				}
//			}
			/*
